...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Función para obtener todo el texto dentro
    function obtenerTextoSeccion() {
        return Array.from(defobjSection.querySelectorAll("h2, h3, h4, p"))
            .map(element => element.innerText.trim()) // Obtener solo el texto de h2, h3, h4, p
            .filter(text => text.length > 0) // Eliminar textos vacíos
            .join(". "); // Unir los textos con punto para pausas naturales
    }
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Función para obtener todo el texto dentro
    function obtenerTextoSeccion() {
        return Array.from(plaSection.querySelectorAll("h2, h3, h4, p"))
            .map(element => element.innerText.trim()) // Obtener solo el texto de h2, h3, h4, p
            .filter(text => text.length > 0) // Eliminar textos vacíos
            .join(". "); // Unir los textos con punto para pausas naturales
    }
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Función para obtener todo el texto dentro
    function obtenerTextoSeccion() {
        return Array.from(indicacontraSection.querySelectorAll("h2, h3, h4, p"))
            .map(element => element.innerText.trim()) // Obtener solo el texto de h2, h3, h4, p
            .filter(text => text.length > 0) // Eliminar textos vacíos
            .join(". "); // Unir los textos con punto para pausas naturales
    }
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Función para obtener todo el texto dentro
    function obtenerTextoSeccion() {
        return Array.from(abverSection.querySelectorAll("h2, h3, h4, p"))
            .map(element => element.innerText.trim()) // Obtener solo el texto de h2, h3, h4, p
            .filter(text => text.length > 0) // Eliminar textos vacíos
            .join(". "); // Unir los textos con punto para pausas naturales
    }
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Función para obtener todo el texto dentro
    function obtenerTextoSeccion() {
        return Array.from(abambSection.querySelectorAll("h2, h3, h4, p"))
            .map(element => element.innerText.trim()) // Obtener solo el texto de h2, h3, h4, p
            .filter(text => text.length > 0) // Eliminar textos vacíos
            .join(". "); // Unir los textos con punto para pausas naturales
    }
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Función para obtener todo el texto dentro
    function obtenerTextoSeccion() {
        return Array.from(abfarmSection.querySelectorAll("h2, h3, h4, p"))
            .map(element => element.innerText.trim()) // Obtener solo el texto de h2, h3, h4, p
            .filter(text => text.length > 0) // Eliminar textos vacíos
            .join(". "); // Unir los textos con punto para pausas naturales
    }
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Función para obtener todo el texto dentro
    function obtenerTextoSeccion() {
        return Array.from(paraborSection.querySelectorAll("h2, h3, h4, p"))
            .map(element => element.innerText.trim()) // Obtener solo el texto de h2, h3, h4, p
            .filter(text => text.length > 0) // Eliminar textos vacíos
            .join(". "); // Unir los textos con punto para pausas naturales
    }
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Función para obtener todo el texto dentro
    function obtenerTextoSeccion() {
        return Array.from(prcSection.querySelectorAll("h2, h3, h4, p"))
            .map(element => element.innerText.trim()) // Obtener solo el texto de h2, h3, h4, p
            .filter(text => text.length > 0) // Eliminar textos vacíos
            .join(". "); // Unir los textos con punto para pausas naturales
    }
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Función para obtener todo el texto dentro
    function obtenerTextoSeccion() {
        return Array.from(materialSection.querySelectorAll("h2, h3, h4, p"))
            .map(element => element.innerText.trim()) // Obtener solo el texto de h2, h3, h4, p
            .filter(text => text.length > 0) // Eliminar textos vacíos
            .join(". "); // Unir los textos con punto para pausas naturales
    }
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Función para obtener todo el texto dentro
    function obtenerTextoSeccion() {
        return Array.from(instauracionSection.querySelectorAll("h2, h3, h4, p"))
            .map(element => element.innerText.trim()) // Obtener solo el texto de h2, h3, h4, p
            .filter(text => text.length > 0) // Eliminar textos vacíos
            .join(". "); // Unir los textos con punto para pausas naturales
    }
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Función para obtener todo el texto dentro
    function obtenerTextoSeccion() {
        return Array.from(precauSection.querySelectorAll("h2, h3, h4, p"))
            .map(element => element.innerText.trim()) // Obtener solo el texto de h2, h3, h4, p
            .filter(text => text.length > 0) // Eliminar textos vacíos
            .join(". "); // Unir los textos con punto para pausas naturales
    }
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Función para obtener todo el texto dentro
    function obtenerTextoSeccion() {
        return Array.from(cuidadoSection.querySelectorAll("h2, h3, h4, p"))
            .map(element => element.innerText.trim()) // Obtener solo el texto de h2, h3, h4, p
            .filter(text => text.length > 0) // Eliminar textos vacíos
            .join(". "); // Unir los textos con punto para pausas naturales
    }
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Función para obtener todo el texto dentro
    function obtenerTextoSeccion() {
        return Array.from(eliminaSection.querySelectorAll("h2, h3, h4, p"))
            .map(element => element.innerText.trim()) // Obtener solo el texto de h2, h3, h4, p
            .filter(text => text.length > 0) // Eliminar textos vacíos
            .join(". "); // Unir los textos con punto para pausas naturales
    }
...
//------------------------------
document.addEventListener("DOMContentLoaded", () => {
    const eliminaSection = document.querySelector(".Audio14");
    const playPauseBtn = eliminaSection.querySelector(".playPause");
    const resetBtn = eliminaSection.querySelector(".reset");
...
//---------------------------------
document.addEventListener("DOMContentLoaded", () => {
    const eliminaSection = document.querySelector(".Audio15");
    const playPauseBtn = eliminaSection.querySelector(".playPause");
    const resetBtn = eliminaSection.querySelector(".reset");
